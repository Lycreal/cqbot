...
class MockResponse:
    with open('tests/test.png', 'rb') as f:
        image_base64: bytes = base64.b64encode(f.read())
    ...
    async def aread(self) -> bytes:
        ...
        elif 'saucenao.com' in self.url:
            with open('tests/Sauce Found.htm', 'rb') as f:
                return f.read()
        elif 'i.pximg.net' in self.url or 'pixiv.cat' in self.url:
            return base64.b64decode(self.image_base64)
        elif self.url == "https://api.thecatapi.com/v1/images/search":
            return b'[{"url": "https://fakeurl/pic.bmp"}]'
    ...
    def json(self):
        ...
        elif 'api.moderatecontent.com' in self.url:
            return {
                "url_classified": "https://pixiv.cat/88049572.png",
                "rating_index": 3,
                "rating_letter": "a",
                "predictions": {
                    "teen": 0.0011656117749225814,
                    "everyone": 39.776378870010376,
                    "adult": 60.222458839416504
                },
                "rating_label": "adult",
                "error_code": 0
            }
